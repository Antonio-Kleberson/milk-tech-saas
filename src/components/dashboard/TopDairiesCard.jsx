  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Melhores preços do leite na sua região
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-3 sm:space-y-4">
          {items.map((dairy) => {
            ...
            return (
              <div key={dairy.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div>
