        ...
        <CardHeader>
          <div className="flex flex-col sm:flex-row justify-between sm:items-start">
            ...
            <div className="flex space-x-2 shrink-0">
              ...
              <Button variant="outline" size="sm" onClick={() => onEditRecipe?.(recipe)} aria-label="Editar receita" title="Editar receita">
                <Edit className="h-4 w-4" aria-hidden="true" />
              </Button>
              <Button variant="outline" size="sm" onClick={() => onDeleteRecipe?.(recipe.id)} aria-label="Excluir receita" title="Excluir receita">
