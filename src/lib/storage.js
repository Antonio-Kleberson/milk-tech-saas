...
export const initializeSampleData = () => {
  if (storage.getDairies().length === 0) {
    ...
    const sampleRecipeItems = [
      // Receita 1 - 75/20/5
      { id: 'demo_ri1', recipe_id: 'demo_r1', ingredient_name: 'Milho',         proportion_type: 'percent', proportion_value: 75 },
      { id: 'demo_ri2', recipe_id: 'demo_r1', ingredient_name: 'Farelo de Soja', proportion_type: 'percent', proportion_value: 20 },
      { id: 'demo_ri3', recipe_id: 'demo_r1', ingredient_name: 'Sal Mineral',    proportion_type: 'percent', proportion_value: 5  },
      // Receita 2 - 70/25/5
      { id: 'demo_ri4', recipe_id: 'demo_r2', ingredient_name: 'Milho',         proportion_type: 'percent', proportion_value: 70 },
      { id: 'demo_ri5', recipe_id: 'demo_r2', ingredient_name: 'Farelo de Soja', proportion_type: 'percent', proportion_value: 25 },
      { id: 'demo_ri6', recipe_id: 'demo_r2', ingredient_name: 'Sal Mineral',    proportion_type: 'percent', proportion_value: 5  }
    ];
